...
import ImageBg from '/assets/image/home.webp';

export default function Hero() {
  //   const [isOpen, setIsOpen] = useState(false); // state for mobile menu

  return (
    <section className="w-full h-full bg-white overflow-hidden z-0 relative ">
      <div className="bg-black lg:w-[90%] md:w[90%]  flex z-50  ">
        ...
        2xl:w-[70%] xl:w-[100%] lg:w-[100%] md:w-[100%] sm:w-[100%] w-[100%] border-0 2xl-h-100"
          ...
          text-base xl:text-[1.2rem] lg:text-[1rem] md:text-[0.8rem] sm:text-[1rem] text-[1rem] mt-4 mb-6 text-left"
            ...
            <div className="xl:flex lg:flex md:flex border-0  xl:gap-5 lg:gap-5 md:gap-2 sm:gap-5 gap-6">
              <button className="bg-[#00D285] text-white xl:px-[2.5rem] xl:py-[1rem] lg:px-[2.5rem] lg:py-[1rem] md:px-[1rem] sm:px-[1.3rem] sm:py-[1rem] px-[1.5rem] py-[1rem] rounded-full font-semibold hover:bg-green-400 mr-5 md:mr-2 sm:mr-5 sm:mb-0 mb-5">
                Get a Quote
              </button>
              <button className="bg-white text-black xl:px-[1.9rem] xl:py-[1rem] lg:px-[2.5rem] lg:py-[1rem] md:px-[1.3rem] sm:px-[1rem] sm:py-[1rem] px-[1.5rem] py-[1rem] rounded-full font-semibold hover:bg-green-400 mr-0 md:mr-2 sm:mr-5 sm:mb-0 mb-5">
                Schedule a Call
              </button>
            </div>
          </div>
        ...
        <div className="xl:w-[40%] lg:w-[40%] md:w-[40%] sm:w-[40%] w-[40%] relative justify md:block hidden">
          ...
          <div className="xl:w-[22rem] xl:h-[30rem] lg:w-[15rem] lg:h-[14rem] md:w-[13rem] md:h-[12rem]
           xl:block lg:block md:hidden sm:hidden hidden relative xl:left-[17rem] lg:left-[12.6rem] md:left-[10.2rem]  border-0 
           bg-[#00D285] z-100 "></div>


          <div className="xl:w-[22rem] xl:h-[25rem] lg:w-[15rem] lg:h-[20rem] md:w-[13rem] md:h-[12rem] 
          xl:block lg:block md:block sm:hidden hidden relative -bottom-2  border-0 bg-[#00D285] z-100 
          xl:left-[5rem] lg:left-[10.6rem] md:left-[16.2rem] sm:left-[20rem] left-[18rem] top-0"></div>

          <img
            // src="public/Image/home1.webp"
            src={ImageBg}
